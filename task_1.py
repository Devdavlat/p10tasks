"""
Department_Information.csv file da universitet fakultetlari va Employee_Information.csv
faylda fakultet ishchilari haqida ma'lumot mavjud. Ushbu ma'lumitlar orqali boshqa csv
faylga quyidagi ko'rinishda ma'lumot chiqaring employee_department_example.csv
